        ...
        <div>
            ...
            <div className='flex gap-2 flex-col justify-between items-center'>
                ...
                <div className='mt-6 w-full'>
                        ...
                        <Link to='/captain-home' className='text-lg w-full mt-5 bg-green-600 flex justify-center text-white font-semibold p-3 rounded-lg'>
                            Finish Ride
                        </Link>

                <p className='text-red-500 mt-10 text-xs font-semibold'>* Click on Finish Ride button if you have completed the payment</p>
